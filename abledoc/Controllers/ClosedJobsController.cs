...
{
    public class ClosedJobsController : Controller
    {
        private readonly IWebHostEnvironment webHostEnvironment;
        public ClosedJobsController(IWebHostEnvironment hostEnvironment)
        {
        ...
        public JsonResult GetJobStatusList(JQueryDataTableParamModel param, int TodayTask)
        {
            ...
            allRecord = objJobMaster.GetJobStatusListForTable(startIndex, endIndex, OrderBy, SearchKey, "CLOSEDJOBS", out totalRecords, TodayTask);
