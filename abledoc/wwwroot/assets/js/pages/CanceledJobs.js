...
function search() {
    if ($.fn.dataTable.isDataTable('#CanceledJobTable')) {
        $('#CanceledJobTable').DataTable().destroy();
        ToDatatable();
    }
    else {
        ToDatatable();
...
function ToDatatable() {
    ...
    var url = '/CancelledJobs/GetCancelJobStatusList';

    var table = $('#CanceledJobTable').DataTable({
